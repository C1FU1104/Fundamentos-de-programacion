            ...
            if (not coordenada2[0]) == False :
                ...
                if (not coordenada2[1]) == False :
                    ...
                    if (not coordenada3[0]) == False :
                        ...
                        if (not coordenada3[0]) == False :
                            if 2.548 <= float(coordenada1[0]) <= 2.766 and  2.548 <= float(coordenada2[0]) <= 2.766 and 2.548 <= float(coordenada3[0]) <= 2.766 and -76.879 <= float(coordenada1[1]) <= -76.493 and -76.879 <= float(coordenada2[1]) <= -76.493 and -76.879 <= float(coordenada3[1]) <= -76.493 :
                                menu()
                            else:
...
def cambio_contrasena():
    ...
    contrasenaEntrada = int(input('Ingrese la contaseña actual: '))
